...
const Dropzone = ({
  ...
  return (
    <div className="mt-16">
      ...
      <label
        htmlFor="file-upload"
        className="relative flex w-full cursor-pointer flex-col items-center justify-center gap-2 rounded-2xl border border-[#6b6b6b] bg-[#181818] px-10 py-10"
      >
        <div className="absolute inset-3 rounded-xl border border-dashed border-[#6b6b6b]"></div>
        <p>Upload file</p>
        <svg
          width="47"
          height="47"
